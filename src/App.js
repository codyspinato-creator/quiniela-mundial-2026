  ...
  const sections = [
    {
      title: "Participación",
      items: [
        "Se requiere código de acceso para entrar",
        "Cada participante registra su nombre y WhatsApp",
        "El costo de la quiniela es de $20",
      ]
    },
    {
      title: "Fecha límite",
      items: [
        "Todas las predicciones deben estar guardadas antes del 11 de junio de 2026",
        "No se aceptan cambios una vez comenzado el torneo",
      ]
    },
  ];
    ...
    <div style={{minHeight:"100vh",background:B.bg,fontFamily:"'SF Pro Display','Helvetica Neue',Arial,sans-serif"}}>
      ...
      <div style={{maxWidth:560,margin:"0 auto",padding:"16px 14px 40px"}}>
        ...
        <div style={{background:"#ffffff",borderRadius:12,padding:16,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
          ...
          {["Se requiere código de acceso para entrar","Cada participante registra su nombre y WhatsApp","El costo de la quiniela es de $20"].map((item,i)=>(
            <div key={i} style={{display:"flex",gap:8,marginBottom:8,fontSize:12,color:"#333",lineHeight:1.5}}>
              <span style={{color:B.primary,fontWeight:"bold",flexShrink:0}}>•</span><span>{item}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{background:"#ffffff",borderRadius:12,padding:16,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
          ...
          {["Todas las predicciones deben estar guardadas antes del 11 de junio de 2026","No se aceptan cambios una vez comenzado el torneo"].map((item,i)=>(
            <div key={i} style={{display:"flex",gap:8,marginBottom:8,fontSize:12,color:"#333",lineHeight:1.5}}>
              <span style={{color:"#f77f00",fontWeight:"bold",flexShrink:0}}>⚠️</span><span>{item}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{background:"#ffffff",borderRadius:12,padding:16,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
          ...
          {[
            {pts:"5",color:"#3a5bd9",label:"Resultado exacto en ese partido específico",example:"Ejemplo: En el partido México vs Sudáfrica predijiste 2-1 y terminó 2-1 ✅"},
            {pts:"3",color:"#7c3aed",label:"Ganador o empate correcto en ese partido específico",example:"Ejemplo: En el partido México vs Sudáfrica predijiste 2-0 y terminó 2-1. Acertaste que ganaba México ✅"},
            {pts:"0",color:"#e63946",label:"Resultado incorrecto",example:"Ejemplo: Predijiste que ganaba México y ganó Sudáfrica ❌"},
          ].map(({pts,color,label,example},i)=>(
            <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:i<2?"1px solid #f0f0f0":"none"}}>
              <div style={{display:"flex",gap:10,alignItems:"flex-start",marginBottom:6}}>
                <div style={{minWidth:32,height:32,borderRadius:8,background:color+"15",border:`1px solid ${color}30`,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:"900",color,fontSize:14,flexShrink:0}}>+{pts}</div>
                <div style={{fontSize:12,color:"#222",fontWeight:"600",lineHeight:1.4,paddingTop:4}}>{label}</div>
              </div>
              <div style={{fontSize:11,color:B.muted,fontStyle:"italic",paddingLeft:42,lineHeight:1.5}}>{example}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{background:"#ffffff",borderRadius:12,padding:16,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
          ...
          <div style={{background:"#fff8f0",border:"1px solid #f77f0040",borderRadius:8,padding:"8px 12px",marginBottom:14,fontSize:11,color:"#7a4000",lineHeight:1.5}}>
            ⚠️ <strong>Cada partido se evalúa de forma completamente independiente.</strong> Lo que predijiste en el P77 no afecta los puntos del P78 ni de ningún otro partido. Si predijiste a Noruega ganando el P77 y efectivamente ganó, esos puntos son solo del P77. En el P78 necesitas haber acertado ese partido específico para sumar.
          </div>
          {[
            {pts:"5",color:"#3a5bd9",label:"Resultado exacto con los 2 equipos correctos en ese partido",example:"Ejemplo: En el P78 predijiste Francia vs Ecuador 2-1 y terminó exactamente Francia vs Ecuador 2-1 ✅"},
            {pts:"3",color:"#7c3aed",label:"Ganador correcto aunque el marcador o los equipos sean distintos",example:"Ejemplo: En el P78 predijiste Francia vs Ecuador 2-1 pero fue Francia vs Costa de Marfil 2-0. Francia ganó en ambos casos ✅"},
            {pts:"+1",color:"#00c853",label:"Por cada equipo que pusiste en ese partido y que sí llegó a jugarlo",example:"Ejemplo: En el P78 pusiste Francia vs Ecuador, pero el partido fue Francia vs Costa de Marfil. Francia sí jugó el P78 ✓ (+1 pt). Ecuador no llegó al P78 ✗ (0 pts)"},
          ].map(({pts,color,label,example},i)=>(
            <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:i<2?"1px solid #f0f0f0":"none"}}>
              <div style={{display:"flex",gap:10,alignItems:"flex-start",marginBottom:6}}>
                <div style={{minWidth:32,height:32,borderRadius:8,background:color+"15",border:`1px solid ${color}30`,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:"900",color,fontSize:12,flexShrink:0}}>{pts}</div>
                <div style={{fontSize:12,color:"#222",fontWeight:"600",lineHeight:1.4,paddingTop:4}}>{label}</div>
              </div>
              <div style={{fontSize:11,color:B.muted,fontStyle:"italic",paddingLeft:42,lineHeight:1.5}}>{example}</div>
            </div>
        ...
        <div style={{background:"#ffffff",borderRadius:12,padding:16,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
          ...
          {[
            {pts:"10",icon:"🥇",label:"Campeón del mundo",example:"Ejemplo: Predijiste Brasil y Brasil ganó el Mundial ✅",color:"#3a5bd9"},
            {pts:"5", icon:"🥈",label:"Subcampeón",example:"Ejemplo: Predijiste Argentina y Argentina perdió la final ✅",color:"#7c3aed"},
            {pts:"5", icon:"🥉",label:"Tercer lugar",example:"Ejemplo: Predijiste Francia y Francia ganó el partido por el bronce ✅",color:"#a07040"},
            {pts:"10",icon:"👟",label:"Goleador del torneo",example:"Ejemplo: Predijiste Mbappé y Mbappé fue el máximo goleador ✅",color:"#00c853"},
          ].map(({pts,icon,label,example,color},i)=>(
            <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:i<3?"1px solid #f0f0f0":"none"}}>
              <div style={{display:"flex",gap:10,alignItems:"flex-start",marginBottom:6}}>
                <div style={{minWidth:32,height:32,borderRadius:8,background:color+"15",border:`1px solid ${color}30`,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:"900",color,fontSize:12,flexShrink:0}}>+{pts}</div>
                <div style={{fontSize:12,color:"#222",fontWeight:"600",lineHeight:1.4,paddingTop:4}}>{icon} {label}</div>
              </div>
              <div style={{fontSize:11,color:B.muted,fontStyle:"italic",paddingLeft:42,lineHeight:1.5}}>{example}</div>
            </div>
          ))}
...
function KnockoutTab({ knockout, setKnockout, scores }) {
  ...
  return (
    <div>
      ...
      {rondaActiva==="r32"&&(<div style={{background:"#f5f5f7",border:"1px solid #e0e0e8",borderRadius:10,padding:"9px 12px",marginBottom:12,fontSize:11,color:B.muted,lineHeight:1.5}}>💡 Escribe el nombre de los equipos que crees que pasan a cada partido de dieciseisavos. Los cruces oficiales se conocerán al terminar la fase de grupos.</div>)}
      ...
      {isFinal&&matches[0]?.ganador&&(<div style={{marginTop:14,background:"linear-gradient(135deg,#eff4ff,#e8f0ff)",border:"2px solid #3a5bd9",borderRadius:14,padding:"16px",textAlign:"center"}}><div style={{fontSize:36,marginBottom:6}}>🏆</div><div style={{fontSize:12,color:B.muted,marginBottom:4}}>¡CAMPEÓN DEL MUNDO 2026!</div><div style={{fontSize:20,fontWeight:"bold",color:B.primary}}>{matches[0].ganador}</div></div>)}
...
export default function App() {
  ...
  const handleLogin=async()=>{
    ...
    try{
      ...
      if(cfgSnap.exists()){const cfg=cfgSnap.data();if(cfg.codigoAcceso&&codigoInput.trim()!==cfg.codigoAcceso){setLoginError("Código de acceso incorrecto ❌");return;}}
    }catch(e){}
    ...
    try{
      ...
      if(snap.exists()){const d=snap.data();setScores(d.scores||{});setCampeon(d.campeon||"");setSegundo(d.segundo||"");setTercero(d.tercero||"");setGoleador(d.goleador||"");setGoleadorCustom(d.goleadorCustom||"");setKnockout(d.knockout||emptyKnockout());setEmailInput(d.email||"");}
    }catch(e){}
  ...
  const saveQuiniela=async()=>{
    ...
    try{await setDoc(doc(db,"quinielas",myId),{nombre:myNombre,email:emailInput.trim(),scores,campeon,segundo,tercero,goleador,goleadorCustom,knockout,updatedAt:Date.now()});setSaveMsg("¡Guardado! ✓");}
  ...
  useEffect(()=>{
    if(screen==="quiniela"&&myId){getDoc(doc(db,"admin","resultados")).then(snap=>{if(snap.exists())setResultadosOficiales(snap.data());}).catch(()=>{});}
  },[screen,myId]);
    ...
    <div style={{minHeight:"100vh",background:B.bg,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'SF Pro Display','Helvetica Neue',Arial,sans-serif",padding:20}}>
      <div style={{maxWidth:360,width:"100%"}}>
        ...
        <div style={{background:"#ffffff",border:"1px solid #e0e0e8",borderRadius:16,padding:24,boxShadow:"0 4px 20px rgba(0,0,0,0.08)"}}>
          ...
          <input autoFocus value={loginInput} onChange={e=>setLoginInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handleLogin()} placeholder="Tu nombre completo..." style={{width:"100%",background:"#f8f8fc",border:"1px solid #ddd",borderRadius:8,padding:"10px 12px",color:"#111",fontSize:14,outline:"none",boxSizing:"border-box",marginBottom:12}}/>
          <div style={{fontSize:12,color:"#444455",fontWeight:"600",marginBottom:6}}>Código de acceso</div>
          <div style={{position:"relative",marginBottom:8}}>
            <input type="password" value={codigoInput} onChange={e=>setCodigoInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handleLogin()} placeholder="Código de la quiniela..." style={{width:"100%",background:"#f8f8fc",border:"1px solid #ddd",borderRadius:8,padding:"10px 12px 10px 36px",color:"#111",fontSize:14,outline:"none",boxSizing:"border-box"}}/>
          ...
          <div style={{position:"relative",marginBottom:12}}>
            <input type="tel" value={emailInput} onChange={e=>setEmailInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handleLogin()} placeholder="+58 123 4567890" style={{width:"100%",background:"#f8f8fc",border:"1px solid #ddd",borderRadius:8,padding:"10px 12px 10px 36px",color:"#111",fontSize:14,outline:"none",boxSizing:"border-box"}}/>
                  ...
                  <div key={q.id} onClick={()=>setSelectedUser(q)} style={{background:isMe?"#eff4ff":"#ffffff",border:`1px solid ${isMe?"#3a5bd9":"#e0e0e8"}`,borderRadius:12,padding:"12px 14px",marginBottom:8,cursor:"pointer"}}>
                    <div style={{display:"flex",alignItems:"center",gap:10}}>
                      ...
                      <div style={{textAlign:"right",flexShrink:0}}>
                        {resultadosOficiales&&Object.keys(resultadosOficiales).length>0?(<div><div style={{fontSize:16,fontWeight:"bold",color:B.primary}}>{calcTotalPoints(q,resultadosOficiales).total} pts</div></div>):(<div style={{fontSize:14,fontWeight:"bold",color:qc.pct===100?B.primary:"#888"}}>{qc.pct}%</div>)}
                      </div>
